 ...
 * Implements OAuth 2.0 authentication and JMAP API calls
 */
...
export class FastmailJMAPClient {
  constructor(config) {
    ...
    this.scope = config.scope || 'urn:ietf:params:jmap:core urn:ietf:params:jmap:mail urn:ietf:params:jmap:submission';
    this.sessionUrl = 'https://api.fastmail.com/jmap/session';
    this.oauthUrl = 'https://api.fastmail.com/oauth/authorize';
    this.tokenUrl = 'https://api.fastmail.com/oauth/refresh';
